                ...
                <div class="panel-body">
                    <form role="form" action="admin/save.html">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="userPswd" id="userPswd" placeholder="请输入登陆密码">
                        </div>
                        <div class="form-group">
                            <label for="userName">用户昵称</label>
                            <input type="text" class="form-control" name="userName" id="userName" placeholder="请输入用户昵称">
                        </div>
                        <div class="form-group">
